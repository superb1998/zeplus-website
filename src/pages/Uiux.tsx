...
<section className="bg-cover bg-center bg-no-repeat w-full flex flex-col md:flex-row md:justify-between md:items-center gap-8 md:gap-0 px-5 sm:px-10 md:px-20 py-6" style={{ backgroundImage: `url(${Hero1bg})` }}>
    ...
    <div className="order-2 md:order-1 text-left md:text-left">
      ...
      <div className="flex flex-row sm:flex-row gap-3 sm:justify-center md:justify-start">
         <a
        href="https://wa.me/2348169669110?text=Hello%2C%20I%20would%20like%20to%20learn%20more%20about%20the%20UI/UX%20Design%20course%20at%20Zeplus%20Academy."
        target="_blank"
...
<div className='bg-gradient-to-r from-[#60070B] to-[#9C0E76] py-10 md:py-14 px-4 md:px-20 mx-4 md:mx-20 rounded-lg'>
  <h1 className='font-poppins text-[22px] md:text-[35px] font-bold text-white text-center mb-5 leading-tight'>
    Learn Anywhere
  </h1>
  <p className='font-inter font-normal text-[16px] md:text-[18px] text-white mb-6 text-center'>
    Choose how you want to learn
  </p>

  <span className='text-white flex flex-col md:flex-row md:gap-4 gap-1 items-start md:items-center mb-4 font-inter text-[16px] md:text-[18px] font-normal'>
    <img src={Tick} alt="tick" className='w-[23px] h-[19px]'/>
    <p><b>In-Person:</b> Learn at any of our Lagos centers.</p>
  </span>

  <span className='text-white flex flex-col md:flex-row md:gap-4 gap-1 items-start md:items-center font-inter text-[16px] md:text-[18px] font-normal'>
    <img src={Tick} alt="tick" className='w-[23px] h-[19px]'/>
