       ...
       <section className='md:max-w-6xl mx-auto mt-10 font-poppins bg-gradient-to-br from-[#60070B] to-[#9C0E76] text-white md:rounded-lg'>
        <div className='md:p-10 md:max-w-2xl max-w-[400px] mx-auto p-6'>
            <div className='flex flex-col gap-1 items-center mb-4'>
                  <h2 className='text-white font-[600] md:text-[30px] text-[45px]'>Learn Anywhere</h2>
                   ...
                   <div className='grid grid-cols-2 gap-10'>
                    {/* 1st */}
                     <div className='flex flex-row gap-4 items-center'>
                        ...
                        <p className='font-[550] md:text-[24px] text-[14px]'>Magodo</p>
                     </div>
                        {/* 2nd */}
                         <div className='flex flex-row gap-4 items-center'>
                        <span>
                        ...
                        <p className='font-[550] md:text-[24px] text-[14px]'>Yaba</p>
                     </div>
                     {/* 3rd */}
                      <div className='flex flex-row gap-4 items-center'>
                        <span>
                        ...
                        <p className='font-[550] md:text-[24px] text-[14px]'>Festac</p>
                     </div>
                        {/* 4th */}
                         <div className='flex flex-row gap-4 items-center'>
                        <span>
                        ...
                        <p className='font-[550] md:text-[24px] text-[14px]'>Ikeja</p>
                     </div>
                   </div>
                </div>
                {/* right side */}
